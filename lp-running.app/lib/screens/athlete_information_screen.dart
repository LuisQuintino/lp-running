...
class AthleteInformationScreen extends StatefulWidget {
  ...
  @override
  _AthleteInformationScreenState createState() =>
      _AthleteInformationScreenState();
}

class _AthleteInformationScreenState
    extends State<AthleteInformationScreen> {
  bool _kneeChecked = false;
  bool _spineChecked = false;
  bool _othersChecked = false;
  bool _isEditingOtherInfo = false;

  final TextEditingController _otherInfoController =
